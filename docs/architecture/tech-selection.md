...
- Electron gives one JavaScript/TypeScript runtime for the desktop shell,
  provider streaming, SSH, SFTP, and persistence.
...
| Electron + xterm.js | Selected. Fastest implementation, strong Node SSH/SFTP and Provider integration, proven ConPTY path; higher memory use is acceptable for the demo. |
